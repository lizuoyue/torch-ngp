...
class _composite_rays_train(Function):
    ...
    def backward(ctx, grad_weights_sum, grad_depth, grad_image):
        ...
        _backend.composite_rays_train_backward(grad_weights_sum, grad_depth, grad_image, sigmas, rgbs, deltas, rays, weights_sum, depth, image, M, N, T_thresh, grad_sigmas, grad_rgbs)
